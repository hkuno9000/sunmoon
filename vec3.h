...
public:
	...
	/// 行列乗算.
	/// @param m 行列.
	/// @details @f$ *this = *this \begin{pmatrix} x & y & z \end{pmatrix} \begin{pmatrix} m11 & m12 & m13 \\ m21 & m22 & m23 \\ m31 & m32 & m33 \end{pmatrix} @f$
	...
	/// @param a ベクタ.
	/// @param m 行列.
	/// @return @f$ \begin{pmatrix} ax & ay & az \end{pmatrix} \begin{pmatrix} m11 & m12 & m13 \\ m21 & m22 & m23 \\ m31 & m32 & m33 \end{pmatrix} @f$
